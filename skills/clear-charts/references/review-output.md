...
Begin with 2–4 sentences that state:

- what the chart appears to help the reader understand;
- what is already working;
- the single largest issue or opportunity.
...
- the question the reader actually needs answered;
- why the current representation blocks that question;
- the recommended alternative;
- what information should be preserved in the transition.
